...
import tecnnectMain from "../../../assets/myprojectsection/TecnnecT/T1.png";
import tecnnectQuickUi from "../../../assets/quickui/qtecnnect.png";
import tecnnectT1 from "../../../assets/myprojectsection/TecnnecT/T1.png";
import tecnnectT2 from "../../../assets/myprojectsection/TecnnecT/T2.png";
import tecnnectT3 from "../../../assets/myprojectsection/TecnnecT/T3.png";
import tecnnectT4 from "../../../assets/myprojectsection/TecnnecT/T4.png";
import tecnnectT5 from "../../../assets/myprojectsection/TecnnecT/T5.png";
import tecnnectT6 from "../../../assets/myprojectsection/TecnnecT/T6.png";

export default function TecnnectProjectPage() {
	const galleryImages = [tecnnectT1, tecnnectT2, tecnnectT3, tecnnectT4, tecnnectT5, tecnnectT6];
	const titleText = "TecnnecT";
	...
	return (
		<main className="min-h-screen bg-[#d7d9e1]">
			<NavbarProjects backgroundColor="#a50817" backHref="/allprojects" />

			<div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 md:px-10">
				<h1 ref={titleRef} className="mb-12 text-center text-4xl font-semibold text-[#a50817] md:mb-16 md:text-5xl">
				...
				<section className="grid gap-10 md:grid-cols-[1fr_1.4fr] md:gap-12">
					<div>
						<div ref={mainPreviewRef} className={`${mainPreviewVisible ? "slide-in-left-right" : "opacity-0"} group mx-auto w-full max-w-sm md:max-w-md`}>
							<Image
								src={tecnnectMain}
								alt="TecnnecT dashboard preview"
								width={520}
								height={320}
						...
						<div ref={projectLinkRef} className={`${projectLinkVisible ? "slide-in-bottom-up" : "opacity-0"} mt-5 text-center`}>
							<h2 className="text-xl font-semibold text-[#a50817]">Project link</h2>
							<Link
								href="https://teknnect-1c19d.web.app"
								target="_blank"
								rel="noreferrer"
								className="text-sm font-medium text-[#1b3553] underline-offset-2 hover:underline"
							>
								teknnect-1c19d.web.app
							</Link>
						</div>
					</div>
					...
					<div className="space-y-8">
						...
						>
							<h2 className="text-2xl font-semibold text-[#a50817] md:text-2xl">Description</h2>
							<p className="mt-2 text-justify text-lg leading-relaxed text-[#1b3553]">
								TecnnecT is a web app for campus rentals, lost-and-found, and messaging.
								I led development, handled backend architecture, and contributed to frontend
								implementation to deliver a practical and reliable platform.
							</p>
						</div>
						...
						>
							<h2 className="text-2xl font-semibold text-[#a50817] md:text-2xl">Role</h2>
							<p className="mt-2 text-justify text-lg leading-relaxed text-[#1b3553]">
								I worked on backend APIs, database design, authentication, and real-time
								messaging features, while also supporting key frontend integrations and
						...
						>
							<h2 className="text-2xl font-semibold text-[#a50817] md:text-2xl">Challenges and Solution</h2>
							<p className="mt-2 text-justify text-lg leading-relaxed text-[#1b3553]">
								One challenge was coordinating multiple features with smooth performance.
								I optimized API responses, improved data handling, and refined system
								structure to keep the app responsive and maintainable.
							</p>
						</div>
					</div>
				</section>
				...
				<section className="mt-16 md:mt-20">
					<h2 className="text-center text-2xl font-semibold text-[#a50817] md:text-xl">Quick UI</h2>
					<div className="mt-5 flex justify-center">
						<button
							...
							aria-label="Open TecnnecT gallery"
						>
							<Image
								src={tecnnectQuickUi}
								alt="TecnnecT quick UI preview"
								width={760}
								height={420}
			...
			{isGalleryOpen && (
				...
				>
					<div
						className="relative w-full max-w-5xl rounded-3xl border border-white/55 bg-linear-to-br from-[#eef7fb]/88 via-[#f8e4e6]/86 to-[#f1d6da]/84 p-4 shadow-[0_20px_60px_rgba(27,53,83,0.22)] backdrop-blur-md md:p-6"
						onClick={(event) => event.stopPropagation()}
					>
						<button
							type="button"
							onClick={() => setIsGalleryOpen(false)}
							className="absolute right-3 top-3 rounded-md border border-[#a50817]/30 bg-white/75 px-2.5 py-1 text-sm font-semibold text-[#1b3553] transition-colors hover:bg-white"
						>
							Close
						</button>
						...
						<div className="relative mx-auto mt-6 w-full max-w-4xl select-none overflow-hidden rounded-2xl border border-white/70 bg-white/45 aspect-video">
							<div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-[22%] overflow-hidden rounded-l-2xl border-r border-white/40">
								<Image
									...
									alt={`TecnnecT gallery image ${previousIndex + 1}`}
									width={1200}
									height={750}
									draggable={false}
							...
							<div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-[22%] overflow-hidden rounded-r-2xl border-l border-white/40">
								<Image
									...
									alt={`TecnnecT gallery image ${nextIndex + 1}`}
									width={1200}
									height={750}
									draggable={false}
									className="h-full w-full translate-x-6 scale-[1.02] object-cover opacity-35 blur-[1px]"
							...
							>
								<Image
									...
									alt={`TecnnecT gallery image ${galleryIndex + 1}`}
									width={1200}
									height={750}
									draggable={false}
							...
							<button
								...
								className="absolute left-3 top-1/2 z-30 -translate-y-1/2 rounded-full border border-[#a50817]/35 bg-white/80 p-2.5 text-[#1b3553] transition-colors hover:bg-white"
							...
							<button
								type="button"
								onClick={showNext}
								className="absolute right-3 top-1/2 z-30 -translate-y-1/2 rounded-full border border-[#a50817]/35 bg-white/80 p-2.5 text-[#1b3553] transition-colors hover:bg-white"
						...
						<div className="mt-4 flex items-center justify-center">
							<p className="rounded-full border border-[#a50817]/35 bg-white/80 px-4 py-1.5 text-sm font-medium text-[#1b3553]">
